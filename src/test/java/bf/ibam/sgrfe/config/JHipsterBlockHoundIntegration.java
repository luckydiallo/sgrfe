...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("bf.ibam.sgrfe.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("bf.ibam.sgrfe.security.DomainUserDetailsService", "createSpringSecurityUser");
