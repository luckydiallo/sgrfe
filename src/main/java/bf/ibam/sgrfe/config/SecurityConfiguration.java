    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        http
            ...
            .authorizeExchange(authz ->
                // prettier-ignore
                authz
                    .pathMatchers(HttpMethod.GET,"/api/filieres").permitAll()
                    .pathMatchers(HttpMethod.GET, "/api/matieres").permitAll()
                    .pathMatchers(HttpMethod.GET, "/services/sgrcore/api/filieres").permitAll()
                    .pathMatchers(HttpMethod.GET, "/services/sgrcore/api/matieres").permitAll()
                    .pathMatchers(HttpMethod.POST, "/services/sgrcore/api/**").authenticated()
                    ...
                    .pathMatchers("/api/admin/**").hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.DIRECTEUR)
