...
import bf.ibam.sgrfe.domain.Authority;
...
/**
 * REST controller for managing {@link bf.ibam.sgrfe.domain.Authority}.
 */
@RestController
...
public class AuthorityResource {
     ...
     */
    @PostMapping("")
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'ROLE_DIRECTEUR')")
