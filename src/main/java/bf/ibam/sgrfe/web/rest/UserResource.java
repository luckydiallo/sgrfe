...
import bf.ibam.sgrfe.web.rest.errors.BadRequestAlertException;
import bf.ibam.sgrfe.web.rest.errors.EmailAlreadyUsedException;
import bf.ibam.sgrfe.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link bf.ibam.sgrfe.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
     ...
     */
    @PostMapping("/users")
    @PreAuthorize("hasAnyAuthority('" + AuthoritiesConstants.ADMIN + "', '" + AuthoritiesConstants.DIRECTEUR + "')")
